...
Service layer for fraud prediction persistence, history retrieval,
and dashboard statistics using embedded SQLite.
"""
...
def create_prediction(input_data: dict, ip_address: str = "unknown") -> dict:
    ...
    pred_val = int(result.get("prediction", 0))
    ...
    """, (
        input_json, result_json, pred_val, conf_val,
